...
contract StreamOverNFT is ERC4907 {
    ...
    function boardingOnChain(uint256 _accountType) public returns (string memory) {
        // SERVICE PROVIDER
    ...
    function RentAnShow(
        ...
        rentShowNFT(_tokenId, _days, _amount);
    }

    function mintShowNFT(
        uint256 _serviceid,
    ...
    function fetchAllUserAvailableNFTShows()
        public
        view
    ...
    function fetchAllUserLendNFTShows() public view returns (uint256[] memory) {
        return userForLendPlans[msg.sender];
    }

    function allLendShowsByIndex(uint256 index)
        public
        view
        returns (Lend memory)
    {
